...
find_library(GLBINDING_DEBUG_LIBRARY glbindingd
             HINTS ${PC_GLBINDING_LIBDIR} ${PC_GLBINDING_LIBRARY_DIRS}
             PATHS ${PROGRAMFILES}/glbinding/lib)


set(GLBINDING_LIBRARIES ${GLBINDING_LIBRARY} )
set(GLBINDING_DEBUG_LIBRARIES ${GLBINDING_DEBUG_LIBRARY} )
...
mark_as_advanced(GLBINDING_INCLUDE_DIR GLBINDING_LIBRARY GLBINDING_DEBUG_LIBRARY)