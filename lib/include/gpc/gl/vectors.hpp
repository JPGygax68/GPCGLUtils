...
namespace gpc {
    ...
    namespace gl {
        ...
        public:
            ...
            //constexpr _vector2_base(const _vector2_base<ElemT> &from) : _elems(from._elems) {}
            template <int Size_>
            constexpr _vector2_base(const _vector2_base<ElemT, Size_> &from) : _vector2_base<ElemT, Size_>(from._elems) {}
            template <int Size_>
        ...
        public:
            constexpr _vector4_base(ElemT x_ = 0, ElemT y_ = 0, ElemT z_ = 0, ElemT w_ = 1) : _vector3_base({ x_, y_, z_, w_ }) {}
            template <int Size_>
            constexpr _vector4_base(const _vector2_base<ElemT, Size_> &from) : _vector4_base<ElemT>(from._elems) {}
            template <int Size_>
